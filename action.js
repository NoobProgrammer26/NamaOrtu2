...
if (anak == "") {
	alert("Please enter the name of the child of PYB 28th Generation or a command\nTolong masukan nama salah satu orang dari GEN 28th PYB atau Command")
	...
	mama = document.getElementById("mom").innerHTML = "Siska Rahajo";
	kdname = document.getElementById("an").innerHTML = anak
	papa = document.getElementById("dad").style.color = "black";
	mama = document.getElementById("mom").style.color = "black";
	...
	papa = document.getElementById("dad").innerHTML = "Unknown/Another Error";
	mama = document.getElementById("mom").innerHTML = "Mandy Simatupang";
	kdname = document.getElementById("an").innerHTML = anak
	papa = document.getElementById("dad").style.color = "black";
	mama = document.getElementById("mom").style.color = "black";
} else if (anak == "DESMOND") {
	papa = document.getElementById("dad").innerHTML = "Unknown/Another Error";
	mama = document.getElementById("mom").innerHTML = "Mandy Simatupang";
	kdname = document.getElementById("an").innerHTML = anak
	papa = document.getElementById("dad").style.color = "black";
	...
	papa = document.getElementById("dad").innerHTML = "Raymond";
	mama = document.getElementById("mom").innerHTML = "Unknown/Another Error";
	kdname = document.getElementById("an").innerHTML = anak
	papa = document.getElementById("dad").style.color = "black";
	mama = document.getElementById("mom").style.color = "black";
	...
	papa = document.getElementById("dad").innerHTML = "Unknown/Another Error";
	mama = document.getElementById("mom").innerHTML = "Elika";
	kdname = document.getElementById("an").innerHTML = anak
	papa = document.getElementById("dad").style.color = "black";
	mama = document.getElementById("mom").style.color = "black";
} else if (anak == "MICKEY") {
	...
	alert("NamaOrtu 2.0 - ERROR : STRING_IS_UNKNOWN\n\nWARNING!\n"+ document.getElementById("isi").value + " didn't exist in our database or command\nPlease try:\n-Looking on the manual\n-Use Capital Letter\n-Get some help\n\n(c) 2018 GSOFT Inc.\n(c) 2018 EFCO Inc. ")
}
}